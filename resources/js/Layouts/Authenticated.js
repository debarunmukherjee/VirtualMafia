...
export default function Authenticated({ auth, header, children }) {
    ...
    return (
        <div className="min-h-screen bg-gray-100">
            <nav className="bg-nav-blue border-b border-gray-100">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between h-16">
                        <div className="flex">
                            ...
                            <div className="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex text-white">
                                <NavLink href={route('ongoing.games')} active={route().current('ongoing.games')}>
                                    Ongoing Games
                                </NavLink>
                            </div>
                            <div className="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex text-white">
                ...
                <div className={(showingNavigationDropdown ? 'block' : 'hidden') + ' sm:hidden'}>
                    <div className="pt-2 pb-3 space-y-1">
                        ...
                        <ResponsiveNavLink href={route('ongoing.games')} active={route().current('ongoing.games')}>
                            Ongoing Games
                        </ResponsiveNavLink>
                    ...
                    <div className="pt-4 pb-1 border-t border-blue-500">
                        <div className="px-4">
                            <div className="font-medium text-base text-gray-100">{auth.user.name}</div>
                            <div className="font-medium text-sm text-gray-300">{auth.user.email}</div>
                        </div>
